...
COOKIES_HELP_EDGE = "https://microsoftedge.microsoft.com/addons/detail/cookies-txt/dilbcaaegopfblcjdjikanigjbcbngbk"
...
class PrerequisitesWidget(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self._btn_deno_install.setProperty("class", "success")
        ...
        self._btn_deno_uninstall.setProperty("class", "error")
        ...
        self._btn_ffmpeg_install.setProperty("class", "success")
        ...
        self._btn_ffmpeg_uninstall.setProperty("class", "error")
        ...
        btn_import_browser.setProperty("class", "success")
        ...
        self._btn_manage_cookies.setProperty("class", "warning")
        ...
        btn_delete_archive.setProperty("class", "warning")
    ...
    def _show_cookies_help(self) -> None:
        ...
        lbl_links.setText(
            ...
            "<b>Edge</b> — <a href=\"" + COOKIES_HELP_EDGE + "\">Cookies txt</a>"
        )
